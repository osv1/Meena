  ...
  function toastr($animate, $injector, $document, $rootScope, $sce, toastrConfig, $q) {
    ...
    function remove(toastId, wasClicked) {
      ...
      if (toast && ! toast.deleting) { // Avoid clicking when fading out
        ...
        $animate.leave(toast.el, null, function(){ //).then(function() {
    ...
    function _createOrGetContainer(options) {
      ...
      $animate.enter(container, target, null, function(){//).then(function() {
      ...
      newToast.open.promise.then(function() {
        _createOrGetContainer(options).then(function() {
          ...
          if (options.newestOnTop) {
            $animate.enter(newToast.el, container, null, function(){ //}).then(function() {
              newToast.scope.init();
            });
          } else {
            var sibling = container[0].lastChild ? angular.element(container[0].lastChild) : null;
            $animate.enter(newToast.el, container, sibling, null, function(){ //).then(function() {
              newToast.scope.init();
            });
          }
        });
